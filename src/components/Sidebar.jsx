...
const Sidebar = () => {
  ...
  const normalLink = "flex item-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 hover:bg-light-gray dark:text-gray-200  dark:hover:text-black  m-2"
    return (
    <div className ='ml-3 h-screen 
      ...
      {activeMenu && (<>
        ...
        <Link to="/" onClick={handelCloseSidebar}
            ...
            <img src = {logo} alt='icon' width= '30px' hiegth = '30px' />
            <span>LifeBaord</span> 
        </Link>
